...
class DinosaursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinosaur" do
    assert_difference('Dinosaur.count') do
      post dinosaurs_url, params: { dinosaur: { b_day: @dinosaur.b_day, height: @dinosaur.height, is_cool: @dinosaur.is_cool, name: @dinosaur.name } }
    end
  ...
  test "should update dinosaur" do
    patch dinosaur_url(@dinosaur), params: { dinosaur: { b_day: @dinosaur.b_day, height: @dinosaur.height, is_cool: @dinosaur.is_cool, name: @dinosaur.name } }
